    ...
    return (
        <Transition className="px-4 my-8 md:py-32 md:px-40">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                {dataFilteredHouses.map(({ id, location, bedrooms, bathroom, image, star, meters, price }) => (
                    <Link key={id} href={`/properties/${id}`}
                        ...
                        <div className="relative -z-[1]">
                            <div className="relative ">
                                <div className="absolute flex items-center px-2 py-1 rounded-lg bg-slate-50 top-2 right-2 text-slate-600">
                                    <LiaStarSolid />
                                ...
                                <div className="px-3 py-5">
                                    ...
                                    <div className="gap-4 mt-2 xl:flex">
                                        <div className="flex items-center justify-center px-2 py-1 rounded-lg my-2 bg-slate-600/30">
                                            <LiaBedSolid />
            ...
            <div className="text-center my-7">
                {counterHouses < dataProperties.length &&(
                    ...
                    <button 
                    className="px-6 py-6 text-white transition-all  duration-150 cursor-pointer bg-slate-700 rounded-xl hover:bg-black"
